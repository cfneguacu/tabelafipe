package br.com.springboot.tabelafipe.requests;
...
public class TabelafipeApplicationTests {
    ...
    public static void setUpClass() {
        TestWatchman.watchman.registerClass(TabelafipeApplicationTests.class);
    }

    @AfterClass
    public static void tearDownClass() {
        TestWatchman.watchman.createReport(TabelafipeApplicationTests.class);
    }
